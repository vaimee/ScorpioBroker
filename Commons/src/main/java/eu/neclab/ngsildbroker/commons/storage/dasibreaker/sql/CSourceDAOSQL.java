...
public class CSourceDAOSQL extends StorageReaderDAO implements ICSourceDAO {

	private final static Logger logger = LogManager.getLogger(CSourceDAOSQL.class);
	...
	public List<String> query(QueryParams qp) {
		logger.info("\ncall on DAO ====> CSourceDAOSQL.query <====\n");
	...
	public List<String> queryExternalCsources(QueryParams qp) throws SQLException {
		logger.info("\ncall on DAO ====> CSourceDAOSQL.queryExternalCsources <====\n");
	...
	public String translateNgsildQueryToSql(QueryParams qp) throws ResponseException {
		logger.info("\ncall on DAO ====> CSourceDAOSQL.translateNgsildQueryToSql <====\n");
	...
	private String getCommonSqlWhereForTypeIdIdPattern(String typeValue, String idValue, String idPatternValue) {
		logger.info("\ncall on DAO ====> CSourceDAOSQL.getCommonSqlWhereForTypeIdIdPattern <====\n");
		String sqlWhere = "";
	...
	private String getSqlWhereByType(String typeValue, boolean includeIdAndIdPatternNullTest) {
		logger.info("\ncall on DAO ====> CSourceDAOSQL.getSqlWhereByType <====\n");
		String sqlWhere = "(";
	...
	public String translateNgsildGeoqueryToPostgisQuery(GeoqueryRel georel, String geometry, String coordinates,
		...
		logger.info("\ncall on DAO ====> CSourceDAOSQL.translateNgsildGeoqueryToPostgisQuery <====\n");
