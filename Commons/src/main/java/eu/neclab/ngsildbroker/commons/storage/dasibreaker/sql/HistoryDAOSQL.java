...
//@Repository
public class HistoryDAOSQL extends StorageReaderDAOSQL implements IHistoryDAO{

	protected final static Logger logger = LoggerFactory.getLogger(HistoryDAOSQL.class);
	...
	public String translateNgsildQueryToSql(QueryParams qp) throws ResponseException {
		logger.info("\ncall on DAO ====> HistoryDAOSQL.translateNgsildQueryToSql <====\n");
	...
	private String getSqlWhereForField(String dbColumn, String value) {
		logger.info("\ncall on DAO ====> HistoryDAOSQL.getSqlWhereForField <====\n");
		String sqlWhere = "";
		if (value.indexOf(",") == -1) {
	...
	public String translateNgsildTimequeryToSql(String timerel, String time, String timeproperty, String endTime,
		...
		logger.info("\ncall on DAO ====> HistoryDAOSQL.translateNgsildTimequeryToSql <====\n");
	...
	public boolean entityExists(String entityId) {
		logger.info("\ncall on DAO ====> HistoryDAOSQL.entityExists <====\n");
