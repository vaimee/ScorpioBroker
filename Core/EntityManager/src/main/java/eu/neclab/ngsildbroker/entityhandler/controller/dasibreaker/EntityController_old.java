...
public class EntityController_old  implements IEntityHandler{

	private final static Logger logger = LoggerFactory.getLogger(EntityController_old.class);
...
//	KafkaOps kafkaOps;
	...
	@Autowired
	public EntityController_old(EntityProducerChannel producerChannel) {
